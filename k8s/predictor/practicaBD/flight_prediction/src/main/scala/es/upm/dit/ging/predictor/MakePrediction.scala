...
object MakePrediction {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val spark = SparkSession
      ...
      .master("k8s://spark-srv:7077")
      .getOrCreate()
    import spark.implicits._

    //Load the arrival delay bucketizer
    val base_path= "/opt/spark-apps/practicaBD"
    ...
    val df = spark
      .readStream
      .format("kafka")
      .option("kafka.bootstrap.servers", "kafka-srv:9092")
    ...
    val writeConfig = WriteConfig(Map("uri" -> "mongodb://admin:password@mongodb-srv:27017/agile_data_science.flight_delay_classification_response?authSource=admin"))
